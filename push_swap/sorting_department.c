...
/*   Updated: 2026/01/06 11:41:53 by knajmech         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
        ...
        if (depth < *min_moves)
        {
            *min_moves = depth;
            /*for (int i = 0; nums[i]; i++)
                ft_printf("%d, depth: %d\n", nums[i], depth);
            ft_printf("\n");*/
            ft_memcpy(g_winning_path, instructions, (depth + 1) * sizeof(int));
        }
        return ;
    }
...
int sort_five(t_manager *heads)
{
    ...
    ft_memset(instructions, 0, (13 * sizeof(int)));
